...
void maxpol(double,double,double,double *);
...
void    getjbar(int, molData *, struct grid *, inputPars *, double *, double *, double *, double *);
void    getMass(inputPars *, struct grid *, const gsl_rng *);
void   	getmatrix(int, gsl_matrix *, molData *, struct grid *, int, double*);
...
void  	photon(int, struct grid *, molData *, int, const gsl_rng *,inputPars *,blend *,double *, double *, double *);
...
void   	stateq(int, struct grid *, molData *, int, inputPars *, double *, double *, double *);
